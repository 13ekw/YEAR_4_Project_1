...
#     plt.show()
#=======================================================================
cdef savedat(double[:,::] arr, int nsteps,float Ts, double[:] ratio, double[:] energy, double[:] order,int nmax):
    """
    Arguments:
	  arr (float(nmax,nmax)) = array that contains lattice data;
...
cdef float all_energy(np.ndarray[double, ndim=2] arr,int nmax):
    ...
    return enall
#=======================================================================
cdef double get_order(np.ndarray[double, ndim=2] arr, int nmax):
    """
    Arguments:
	  arr (float(nmax,nmax)) = array that contains lattice data;
      nmax (int) = side length of square lattice.
    ...
    cdef double[:,:,:] lab = np.empty((3, nmax, nmax))
